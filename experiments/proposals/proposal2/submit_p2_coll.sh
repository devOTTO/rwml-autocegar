...
#SBATCH --array=1-72%6
#SBATCH --output=logs/p2-coll_%A_%a.out
#SBATCH --error=logs/p2-coll_%A_%a.err
...
LINE=$(sed -n "${SLURM_ARRAY_TASK_ID}p" experiments/proposals/proposal2/p2_coll_grid.txt)
echo "[p2-coll ${SLURM_ARRAY_TASK_ID}] $LINE"
