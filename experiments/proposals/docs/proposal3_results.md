...
gate on after warm-up, indicative baseline). A later sweep re-ran P3 over
...
|---|--|--|--|--|--|--|--|--|--|
| P3-consistency | 0.524 | 0.602 | 0.173 | 1.000 | 0.157 | 0.162 | 0.513 | **0.447** | 6/7 |
...
| P3-consistency | 0.413 | 0.602 | 0.173 | 1.000 | 0.151 | 0.117 | 0.501 | **0.422** | 3/7 |
