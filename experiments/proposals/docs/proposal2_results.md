...
gate on after warm-up, indicative baseline). A later sweep re-ran P2 over
...
|---|--|--|--|--|--|--|--|--|--|
| P2-uncertainty | 0.532 | 0.608 | 0.173 | 1.000 | 0.155 | 0.175 | 0.537 | **0.454** | 6/7 |
...
| P2-uncertainty | 0.418 | 0.608 | 0.173 | 1.000 | 0.151 | 0.118 | 0.499 | **0.424** | 3/7 |
